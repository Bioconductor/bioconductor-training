...
## Full rowRanges, which includes rowData
write.table(cbind(seqnames = seqnames(rowRanges(se)),
          ...
          file = "GSE96870_rowranges_all.tsv", row.names=FALSE, sep="\t",
          quote=FALSE)
...
## Cerebellum rowRanges, which includes rowData
write.table(cbind(seqnames = seqnames(rowRanges(se_cereb)),
                  start = start(rowRanges(se_cereb)), end = end(rowRanges(se_cereb)),
                  strand = strand(rowRanges(se_cereb)), mcols(rowRanges(se_cereb))),
          file = "GSE96870_rowranges_cerebellum.tsv", row.names=FALSE, sep="\t",
          quote=FALSE)
```
