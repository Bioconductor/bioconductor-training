...
Map and table showing people in the Bioconductor community who are certified Carpentries instructors or in the process of obtaining certification, such as those in the Bioconductor Carpentries training program. If you are certified and don't see your name, please add yourself as described in this GitHub issue.

See this page for Bioconductor Carpentries Workshops.
...
# Increase padding to zoom out by about 10%
lon_pad <- diff(lon_range) * 0.2  # 20% padding
...
gg <- ggplot() +
  ...
  theme(
    ...
    legend.margin = margin(t = 0, b = 0, unit = 'pt')  # Reduce legend margins
  )

# Convert to interactive plotly plot
interactive_map <- ggplotly(gg, tooltip = "text") %>%
  layout(
    margin = list(l = 20, r = 20, t = 20, b = 50),  # Adjust margins as needed
    legend = list(
...
all |>   
    select(name, institution, city, country, status) |> 
